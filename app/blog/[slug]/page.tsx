              ...
              <div className="prose max-w-none">
                <ReactMarkdown
                  components={{
                    ...
                    blockquote({ children }) {
                      const text = children[1].props.children.toString();
          ...
          <div className="sticky top-0 start-0 py-8 lg:ps-4 lg:ps-8">
            ...
            <div className="space-y-6">
              ...
              <a className="group flex items-center gap-x-6" href="#">
                ...
                <div className="flex-shrink-0 relative rounded-lg overflow-hidden w-20 h-20">
                  {/* <img className="w-full h-full absolute top-0 start-0 object-cover rounded-lg" src="https://images.unsplash.com/photo-1542125387-c71274d94f0a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80" alt="Image Description"> */}
                </div>
              </a>
              ...
              <a className="group flex items-center gap-x-6" href="#">
                ...
                <div className="flex-shrink-0 relative rounded-lg overflow-hidden w-20 h-20">
                  {/* <img className="w-full h-full absolute top-0 start-0 object-cover rounded-lg" src="https://images.unsplash.com/photo-1586232702178-f044c5f4d4b7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80" alt="Image Description"> */}
                </div>
              </a>
            </div>
          </div>
